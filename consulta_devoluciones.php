  ...
  <table border="0" cellpadding="0" cellspacing="0" width="743" >
    <tbody>
      ...
      <tr align="center" class="centrar">
        ...
        <td width="315"  valign="baseline" bgcolor="#c3131e"class="negrita">Cliente</td>
        <td width="119"  valign="baseline" bgcolor="#c3131e"class="negrita">Cedula</td>
        <td width="176" valign="baseline" bgcolor="#c3131e" class="negrita">Fecha y Hora</td>
        <td width="106" valign="baseline" bgcolor="#c3131e" class="negrita">Ver</td>
