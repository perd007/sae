...
if($totalRows_compras==0){
  echo "<script type=\"text/javascript\">alert ('No existen Compras Registradas');  location.href='fondo.php' </script>";
  exit;
  }
?>
...
<table border="0" cellpadding="0" cellspacing="0" width="760" >
  <tbody>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="103"  valign="baseline" bgcolor="#0000FF"class="negrita">Fecha</td>
      <td width="122" valign="baseline" bgcolor="#0000FF" class="negrita"><label for="tipo2">N° Factura</label></td>
      <td width="375" valign="baseline" bgcolor="#0000FF" class="negrita">Proveedor</td>
      <td width="68" valign="baseline" bgcolor="#0000FF" class="negrita">Opciones</td>
      <td width="66" valign="baseline" bgcolor="#0000FF" class="negrita">Opciones</td>
