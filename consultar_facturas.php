...
$query_pedidos = "SELECT * FROM facturas $filtro order by fecha desc";
...
<table border="0" cellpadding="0" cellspacing="0" width="770" >
  <tbody>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="232"  valign="baseline" bgcolor="#0000FF"class="negrita">Cliente</td>
      <td width="119"  valign="baseline" bgcolor="#0000FF"class="negrita">Cedula</td>
      <td width="154" valign="baseline" bgcolor="#0000FF" class="negrita">Factura</td>
      <td width="158" valign="baseline" bgcolor="#0000FF" class="negrita">Fecha y Hora</td>
      <td width="81" valign="baseline" bgcolor="#0000FF" class="negrita">Visualizar</td>
