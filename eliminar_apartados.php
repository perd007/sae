...
function validar(){
			...
			var valor=confirm('¿Esta seguro de Eliminar este Apartado?');
			if(valor==false){
			return false;
			}
			else{
...
<table border="0" cellpadding="0" cellspacing="0" width="776">
  <tbody>
    <tr>
      ...
      <td align="center" valign="center" background="imagenes/v_back_sup.jpg" class="tituloDOSE_3">&nbsp;</td>
    ...
    <tbody>
      ...
      <td class="tituloDOSE_2" valign="top" width="750"></td>
    </tr>
    <tr>
      <td class="tituloDOSE_2" >&nbsp;</td>
    </tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="775">
  <tbody>
    <tr>
      <td align="left" height="1"><img src="imagenes/vc_esq_izq_sup.gif" alt="7" height="32" width="13" /></td>
      <td class="tituloDOSE_3" align="center" background="imagenes/v_back_sup.jpg" valign="center"><span class="negrita">Apartado a Eliminar</span></td>
    ...
    <tr >
      <td valign="top"><table width="700" align="center" class="tblLista">
        ...
        <tr id="lista_detalles">
          ...
          <td width="71" scope="col"><?=$row_productos_pedidos['cantidad']; ?>
            <input type="hidden" name="cantidad<?=$i?>" value="<?=$row_productos_pedidos['cantidad']?>" /></td>
          <td width="68" scope="col"><?=$row_pedido['total']; ?>
            <input type="hidden" name="precio<?=$i?>" id="precio<?=$i?>" value="<?=$row_productos_pedidos['total']?>" /></td>
          <td width="72" scope="col"><?=$row_pedido['abono']; ?></td>
          <td width="80" scope="col"><?=$row_pedido['total'] - $row_pedido['abono']; ?></td>
        </tr>
        <?php 
		  $i++;
    ...
    <tr>
      ...
      <td align="center" valign="top"><input type="submit" name="button2" id="button2" value="ELIMINAR APARTADO" /></td>
