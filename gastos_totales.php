...
<body>
<form id="form1" name="form1" method="post" action="gastos_totales2.php">
  <table border="0" cellpadding="0" cellspacing="0" width="710">
    <tbody>
      <tr>
        <td align="left" height="1"><img src="imagenes/vc_esq_izq_sup.gif" alt="7" height="32" width="13" /></td>
        <td align="center" valign="center" background="imagenes/v_back_sup.jpg" class="tituloDOSE_3"><span class="negrita">Visualizar Gastos Totales por Fecha</span></td>
