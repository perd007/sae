...
<body>
<form id="form1" name="form1" method="post" action="lista_apartados.php">
...
<table border="0" cellpadding="0" cellspacing="0" width="743" >
  <tbody>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="222"  valign="baseline" bgcolor="#c3131e"class="negrita">Cliente</td>
      <td width="119"  valign="baseline" bgcolor="#c3131e"class="negrita">Cedula</td>
      <td width="192" valign="baseline" bgcolor="#c3131e" class="negrita">Fecha y Hora</td>
      <td width="92" valign="baseline" bgcolor="#c3131e" class="negrita">Confirmar</td>
      <td width="92" valign="baseline" bgcolor="#c3131e" class="negrita">Eliminar</td>
	  ...
	  ?>
        <tr class="trListaBody" style=" font-size: 14px;">
          ...
          <td align="center"><a href="confirmar_apartados.php?apartado=<?php echo $row_pedidos['id_apartado']; ?>"><img src="imagenes/confirmar.png" width="81" height="26" />
          </a></td>
          <td align="center"><a href="eliminar_apartados.php?apartado=<?php echo $row_pedidos['id_apartado']; ?>"><img src="imagenes/botonEliminar.png" width="81" height="26" /></a></td>
          <td background="imagenes/v_back_der.gif">&nbsp;</td>
        </tr>
