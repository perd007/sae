...
<table width="88%" align="left" class="tblLista">
	<thead>
	<tr>
		<th width="298" scope="col">Nombre</th>
        <th width="482" scope="col">Descripcion</th>
	...
	//	consulto todos
	$sql = "SELECT *
			FROM productos where tipo='insumo' or tipo='producto'
