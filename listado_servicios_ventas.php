...
<form name="frmentrada" id="frmentrada" action="" method="post">
...
<table align="left"  class="tblLista">
	<thead>
	<tr>
...
$totalRows_precios = mysql_num_rows($precios);	
			...
			?><tr class="trListaBody" <? if($row_precios['precio']!=""){ ?>onclick="requerimiento_pedido('<?=$field["id_productos"]?>', 'item','<?=(number_format($row_precios['precio'],"2",",","."))?>', '<?=($disponible)?>');" <? } ?> id="<?=$field['id_productos']?>">
