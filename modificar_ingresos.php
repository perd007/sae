...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	$num=$_POST['monto'];
		$num = str_replace(".","",$num);
		$num = str_replace(",",".",$num);
  $updateSQL = sprintf("UPDATE ingresos_diarios SET monto=%s, observaciones=%s, fecha=%s WHERE id_ingresos=%s",
...
$id=$_GET["id"];
mysql_select_db($database_conexion, $conexion);
$query_ingreos = "SELECT * FROM ingresos_diarios where id_ingresos=
$id";
$ingreos = mysql_query($query_ingreos, $conexion) or die(mysql_error());
$row_ingreos = mysql_fetch_assoc($ingreos);
$totalRows_ingreos = mysql_num_rows($ingreos);
?>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table border="0" cellpadding="0" cellspacing="0" width="668">
    <tbody>
      <tr>
        ...
        <td class="tituloDOSE_3" align="center" background="imagenes/v_back_sup.jpg" valign="center"><span class="negrita">Modificar Ingresos</span></td>
          ...
          <tbody>
            ...
            <tr>
              <td align="center" width="642"><table  width="643"  cellpadding="3" cellspacing="0">
                <tbody>
                  <tr>
                    <td width="79" align="right" valign="baseline" nowrap="nowrap"><strong>Monto:</strong></td>
                    <td colspan="3" align="left"><label for="clasificacion">
                      <input name="monto" type="text" class="Letras" id="monto"  style="text-align:right; font-weight:bold;" onfocus="numeroFocus(this);" onblur="numeroBlur(this);" onchange="return validaFloat()" value="<?php echo $row_ingreos['monto']; ?>" />
                    </label></td>
                  </tr>
                  <tr>
                    <td align="right" valign="baseline" nowrap="nowrap"><strong>Fecha</strong></td>
                    <td colspan="3" align="left"><input name="fecha"  type="text" id="fecha" value="<?php echo $row_ingreos['fecha']; ?>" size="20" maxlength="10" readonly="readonly" />
                  ...
                  <tr>
                    ...
                    <td colspan="3" valign="baseline"><label for="observaciones"></label>
                      <textarea name="observaciones" onkeydown="if(this.value.length &gt;= 500){ alert('Has superado el tamaño máximo permitido de este campo'); return false; }" id="observaciones" cols="75" rows="6"><?php echo $row_ingreos['observaciones']; ?></textarea></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="4" align="center"><input type="submit" value="MODIFICAR INGRESO" /></td>
                  </tr>
                </tbody>
              </table></td>
            </tr>
  ...
  <input type="hidden" name="id" value="<?php echo $row_ingreos['id_ingresos']; ?>" />
</form>
<p>&nbsp;</p>
</body>
</html>
<?php
mysql_free_result($ingreos);
?>
